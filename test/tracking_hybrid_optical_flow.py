...
# for opencv version 3.2 and python version 2.7
# instructions below

# path to source video
source_path = '/home/stephen/Desktop/source_clips/55550_s_meschke.avi'
# out path to save tracking data
output_path = '/home/stephen/Desktop/4.csv'
